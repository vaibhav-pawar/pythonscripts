...
def mail():
    ...
    # storing the subject 
    msg['Subject'] = f"IE1-Ireland | AP Negotiating at 1Gbps Report | {ReportDate}"
    ...
    <html>
      <body>
        ...
        <h5>Please find the attached report of AP that are Negotiating at 1Gbps on IE1-Ireland Networks.<h5>
