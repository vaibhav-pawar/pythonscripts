...
def main():
    ...
    networks = dashboard.organizations.getOrganizationNetworks(org_id, tags=["3-IE1"])
    ...
    excel_file = xlsxwriter.Workbook(f'{datetime.now().strftime("%d-%m-%Y-%H%M")}-CRCErrors[3-IE1].xlsx')
