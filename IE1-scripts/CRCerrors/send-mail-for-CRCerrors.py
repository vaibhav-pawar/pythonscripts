...
def mail():
    ...
    # storing the subject 
    msg['Subject'] = f"IE1-Ireland | High Proportion of CRC Errors Report | {ReportDate}"
    ...
    <html>
      <body>
        ...
        <h5>Please find the attached report of High Proportion of CRC Errors on IE1-Ireland Networks.<h5>
