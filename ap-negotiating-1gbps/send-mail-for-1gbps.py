...
def mail():
    ...
    # storing the subject 
    msg['Subject'] = f"0-Active | AP Negotiating at 1Gbps Report | {ReportDate}"
    ...
    <html>
      <body>
        ...
        <h5>Please find the attached report of AP that are Negotiating at 1Gbps on 0-Active Networks.<h5>
